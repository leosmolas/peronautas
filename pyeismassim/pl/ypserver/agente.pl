...
%descripción: envia un dato a un receptor en particular.
...
%descripción: envia un dato a todos los agentes registrados en el servidor de páginas amarillas.
...
%descripción: recibe un mensaje dejado en el servidor. Si no tiene nada cuelga esperando que le llegue.
...
%descripción: recibe un mensage que le llegue, esperando el tiempo dado por +TimeOut. Luego de eso sigue.
...
%descripción: recibe todos los mensajes que se encuentran en en servidor, esperando el tiempo dado por +TimeOut. Luego de eso sigue.
...
%descripción: registra al agente con ciertas caracteristicas y una ontologia en el servidor.
...
%descripción: busca los nombres de los agentes con cierta caracteristica y ontologia.
...
%descripción: retorna todos los tipos de caracteristicas de los agentes registrados bajo una cierta ontologia.
...
%descripción: elimina el conjunto de caracteristicas con las cuales un agente fue registradas.
